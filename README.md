...
because it's just text substitution.) It felt like the Wise Ones, from the top of Mount Turing, had granted us,
...
(stepping through line numbers in that code, keeping track of variables, etc).
